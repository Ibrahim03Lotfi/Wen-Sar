    ...
    <div class="max-w-md w-full mx-4">
        <div class="bg-white rounded-2xl shadow-xl p-8">
            <div class="text-center mb-8">
                <h1 class="text-2xl font-bold text-gray-800 mb-2"><?php echo e($title); ?></h1>
                <p class="text-gray-500">اختر نوع الحساب للمتابعة</p>
            </div>

            <div class="space-y-4">
                <a href="<?php echo e($route); ?>?role=user" 
                ...
                <a href="<?php echo e($route); ?>?role=owner" 
                   class="flex items-center gap-4 p-6 border-2 border-gray-100 rounded-xl hover:border-brand-green hover:bg-brand-green/5 transition-all group">
                    <div class="w-14 h-14 bg-brand-green/10 rounded-full flex items-center justify-center group-hover:bg-brand-green/20">
                        <svg class="w-7 h-7 text-brand-green" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="mt-6 text-center">
                <?php if($action === 'register'): ?>
                    <p class="text-gray-500 text-sm">
                        لديك حساب بالفعل؟ 
                        <a href="<?php echo e(route('select-role')); ?>" class="text-brand-green font-bold hover:underline">تسجيل الدخول</a>
                    </p>
                <?php else: ?>
                    <p class="text-gray-500 text-sm">
                        ليس لديك حساب؟ 
                        <a href="<?php echo e(route('select-role')); ?>?action=register" class="text-brand-green font-bold hover:underline">إنشاء حساب</a>
                    </p>
                <?php endif; ?>
            </div>
        </div>
...
<?php /**PATH C:\Users\LENOVO\Desktop\Wen-Sar\resources\views\auth\select-role.blade.php ENDPATH**/ ?>