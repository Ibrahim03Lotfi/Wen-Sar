...
<div class="bg-white py-12 min-h-screen">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex justify-center mb-10">
            <div class="bg-white px-6 py-3 rounded-full shadow-md border border-gray-100 flex items-center gap-3">
                ...
                <span class="text-gray-600 font-medium">
                    معروض <span class="text-brand-green font-bold text-lg"><?php echo e($businesses->count()); ?></span> منشأة مميزة
                </span>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-5">
            <?php $__empty_1 = true; $__currentLoopData = $businesses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $business): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-500 border border-gray-100 group hover:-translate-y-2">
                ...
                <div class="p-4">
                    ...
                    <div class="flex justify-between items-start mb-2">
                        <span class="text-[10px] font-bold text-brand-green px-2 py-1 bg-brand-green/5 rounded-lg truncate max-w-[60%]"><?php echo e($business->category->name); ?></span>
                        <div class="flex items-center bg-yellow-50 px-2 py-1 rounded-lg border border-yellow-100">
                            <span class="text-xs font-bold text-yellow-700 ml-1"><?php echo e(number_format($business->averageRating(), 1)); ?></span>
                    ...
                    <!-- Name -->
                    <h3 class="text-sm font-bold text-gray-800 mb-2 truncate group-hover:text-brand-green transition-colors line-clamp-2" style="min-height: 2.5rem;"><?php echo e($business->name); ?></h3>
                    ...
                    <div class="flex items-center text-gray-400 text-xs mb-3">
                        ...
                        <span class="truncate"><?php echo e($business->subArea?->name ?? 'غير محدد'); ?></span>
                    </div>
                    ...
                    <div class="flex justify-between items-center pt-3 border-t border-gray-100">
                        ...
                        <a href="<?php echo e(route('business.show', $business->id)); ?>" class="text-brand-green font-bold text-xs flex items-center gap-1 hover:gap-2 transition-all">
                            عرض
            ...
            <div class="col-span-full text-center py-20">
                ...
                <a href="<?php echo e(route('home')); ?>" class="inline-flex items-center gap-2 mt-6 bg-brand-green text-white font-bold px-6 py-3 rounded-xl hover:opacity-90 transition-all">
        ...
        <div class="mt-16 text-center">
            <div class="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 max-w-2xl mx-auto">
                ...
                <a href="<?php echo e(route('select-role')); ?>?action=register" class="inline-flex items-center gap-2 bg-brand-green text-white font-bold px-8 py-4 rounded-xl hover:opacity-90 transition-all shadow-lg shadow-brand-green/20">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\LENOVO\Desktop\Wen-Sar\resources\views\businesses\featured.blade.php ENDPATH**/ ?>