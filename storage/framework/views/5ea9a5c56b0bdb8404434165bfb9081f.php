<?php $__env->startSection('title', __('Add District')); ?>
<?php $__env->startSection('page-title', __('Add New District')); ?>
...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-xl shadow-sm">
        ...
        <form method="POST" action="<?php echo e(route('manager.districts.store')); ?>" class="p-6">
            <?php echo csrf_field(); ?>
            ...
            <div class="mb-6">
                ...
                <select name="governorate_id" required
                    ...
                    <?php $__currentLoopData = $governorates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gov): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($gov->id); ?>" <?php echo e(old('governorate_id') == $gov->id ? 'selected' : ''); ?>><?php echo e($gov->name); ?></option>
...
<?php echo $__env->make('layouts.manager', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\LENOVO\Desktop\Wen-Sar\resources\views\manager\districts\create.blade.php ENDPATH**/ ?>