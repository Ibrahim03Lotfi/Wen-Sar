...
<div class="bg-gray-50 min-h-screen pb-12">
    <div class="bg-brand-green py-8 shadow-inner relative overflow-hidden">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            ...
            <p class="text-brand-white/70 font-medium">تحديث معلومات "<?php echo e($business->name); ?>"</p>
        </div>
    </div>
    ...
    <div class="max-w-4xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        ...
        <form action="<?php echo e(route('owner.businesses.update', $business->id)); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
            <?php echo csrf_field(); ?>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" value="<?php echo e(old('name', $business->name)); ?>" required class="w-full border-gray-300 rounded-lg py-3 px-4 focus:ring-2 focus:ring-brand-green focus:border-brand-green bg-white text-gray-800">
                    </div>

                    <!-- English Name -->
                    <div>
                        <label class="block text-sm font-bold text-gray-700 mb-2">اسم المنشأة بالإنجليزي</label>
                        <input type="text" name="english_name" dir="ltr" value="<?php echo e(old('english_name', $business->english_name)); ?>" class="w-full border-gray-300 rounded-lg py-3 px-4 focus:ring-2 focus:ring-brand-green focus:border-brand-green bg-white text-gray-800" placeholder="Example: Olive Restaurant, Luxury Salon...">
                    </div>

                    <!-- Description -->
                    <div>
                        <label class="block text-sm font-bold text-gray-700 mb-2">الوصف <span class="text-red-500">*</span></label>
                        <textarea name="description" rows="3" required class="w-full border-gray-300 rounded-lg py-3 px-4 focus:ring-2 focus:ring-brand-green focus:border-brand-green bg-white text-gray-800"><?php echo e(old('description', $business->description)); ?></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden"
                 x-data="{ 
                    governorateId: '<?php echo e($business->district->governorate_id ?? ''); ?>',
                    districtId: '<?php echo e($business->district_id); ?>',
                    subAreaId: '<?php echo e($business->sub_area_id ?? ''); ?>',
                    subAreas: [],
                    districts: [],
                    <?php
                    ...
                    ?>
                    categoryId: '<?php echo e($mainCategoryId); ?>',
                    subcategories: [],
                ...
                <div class="p-6 space-y-4">
                            ...
                            <div class="relative">
                                <select name="governorate_id" x-model="governorateId" required
                                    ...
                                    <?php $__currentLoopData = $governorates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $governorate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($governorate->id); ?>" <?php echo e(($business->district->governorate_id ?? '') == $governorate->id ? 'selected' : ''); ?>><?php echo e($governorate->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                        ...
                        <div class="relative">
                            <select name="subcategory_id" class="w-full border-gray-300 rounded-lg py-3 pl-4 pr-10 focus:ring-2 focus:ring-brand-green focus:border-brand-green bg-white appearance-none cursor-pointer">
                                ...
                                <template x-for="subcategory in subcategories" :key="subcategory.id">
                                    <option :value="subcategory.id" x-text="subcategory.name" :selected="subcategory.id == <?php echo e($business->category_id); ?>"></option>
                                </template>
                            </select>
                            <div class="absolute left-3 top-1/2 -translate-y-1/2 pointer-events-none text-gray-500">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div>
                        ...
                        <input type="text" name="address" value="<?php echo e($business->address ?? ''); ?>" required class="w-full border-gray-300 rounded-lg py-3 px-4 focus:ring-2 focus:ring-brand-green focus:border-brand-green bg-white text-gray-800" placeholder="الشارع، المبنى، الطابق، بالقرب من...">
                    </div>

                    <!-- Google Maps Link -->
                    <div>
                        <label class="block text-sm font-bold text-gray-700 mb-2">رابط خرائط غوغل</label>
                        <input type="url" name="google_maps_link" dir="ltr" value="<?php echo e($business->google_maps_link ?? ''); ?>" class="w-full border-gray-300 rounded-lg py-3 px-4 focus:ring-2 focus:ring-brand-green focus:border-brand-green bg-white text-gray-800" placeholder="https://maps.google.com/...">
...
<?php endif; ?>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div class="p-6 space-y-6" data-storage-url="<?php echo e(asset('storage/')); ?>">
                    ...
                    <div>
                        ...
                        <?php if($business->logo): ?>
                            <div id="existingLogo" class="mt-4 relative w-32 h-32">
                                <img src="<?php echo e(asset('storage/' . $business->logo)); ?>" alt="Existing Logo" class="w-full h-full object-cover rounded-xl border-2 border-gray-200">
                    ...
                    <div>
                        ...
                        <div id="imagePreviews" class="mt-4 grid grid-cols-4 gap-3">
                            <?php if($business->images && count($business->images) > 0): ?>
                                ...
                                <div class="relative group existing-image" data-path="<?php echo e($image); ?>">
                                    <img src="<?php echo e(asset('storage/' . $image)); ?>" alt="Existing Image" class="w-full h-24 object-cover rounded-lg border-2 border-gray-200 group-hover:border-brand-green transition">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="url" name="facebook" value="<?php echo e($business->social_links['facebook'] ?? ''); ?>" dir="ltr" class="w-full border-gray-300 rounded-lg py-3 px-4 focus:ring-2 focus:ring-brand-green focus:border-brand-green bg-white text-gray-800" placeholder="https://facebook.com/...">
                    </div>
                    <!-- Instagram -->
                    <div>
                        <label class="block text-sm font-bold text-gray-700 mb-2">إنستغرام</label>
                        <input type="url" name="instagram" value="<?php echo e($business->social_links['instagram'] ?? ''); ?>" dir="ltr" class="w-full border-gray-300 rounded-lg py-3 px-4 focus:ring-2 focus:ring-brand-green focus:border-brand-green bg-white text-gray-800" placeholder="https://instagram.com/...">
                    </div>
                </div>
            </div>
            ...
            <div class="pt-4 flex gap-4">
                ...
                <a href="<?php echo e(route('dashboard')); ?>" class="py-4 px-8 rounded-xl border border-gray-300 font-bold text-gray-600 hover:bg-gray-50 transition-colors">
                    إلغاء
                </a>
            </div>
        </form>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\LENOVO\Desktop\Wen-Sar\resources\views\owner\businesses\edit.blade.php ENDPATH**/ ?>