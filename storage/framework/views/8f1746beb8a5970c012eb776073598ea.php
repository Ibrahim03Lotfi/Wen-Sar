...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden" x-data="{
    hasOverrides: <?php echo e(!empty($overrides) ? 'true' : 'false'); ?>,
    overrides: <?php echo e(json_encode($overrides)); ?>,
    selectedDay: '',
    addOverride(day) {
        ...
        <div>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="time" name="opening_time" value="<?php echo e($regularOpen); ?>" required
                ...
                <div>
                    ...
                    <input type="time" name="closing_time" value="<?php echo e($regularClose); ?>" required
                           class="w-full border-gray-300 rounded-lg py-3 px-4 focus:ring-2 focus:ring-brand-green focus:border-brand-green bg-white text-gray-800">
                </div>
            </div>
            ...
            <div class="flex flex-wrap gap-3">
                <?php $__currentLoopData = $days; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <label class="inline-flex items-center gap-2 cursor-pointer bg-gray-50 px-3 py-2 rounded-lg border border-gray-200 hover:bg-gray-100 transition-colors">
                        <input type="checkbox" name="closed_days[]" value="<?php echo e($key); ?>"
                               <?php echo e(in_array($key, (array)$closedDays) ? 'checked' : ''); ?>
        ...
        <div>
            ...
            <div x-show="hasOverrides" x-transition class="space-y-3">
                ...
                <div class="flex flex-wrap gap-2">
                    <?php $__currentLoopData = $days; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <button type="button"
                                x-show="!overrides['<?php echo e($key); ?>']"
                                @click="addOverride('<?php echo e($key); ?>')"
...
<?php /**PATH C:\Users\LENOVO\Desktop\Wen-Sar\resources\views/components/business-hours.blade.php ENDPATH**/ ?>