        ...
        <div class="bg-gray-50 min-h-screen py-12">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex justify-between items-center mb-8">
                    ...
                    <a href="<?php echo e(route('owner.businesses.create')); ?>" 
                    ...
                    <div class="bg-white rounded-2xl shadow-sm p-6 border border-gray-100">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-3xl font-bold text-brand-green mt-1"><?php echo e($businesses->count()); ?></p>
                            </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm p-6 border border-gray-100">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-3xl font-bold text-blue-600 mt-1"><?php echo e($businesses->sum('views_count')); ?></p>
                            </div>
                ...
                <div class="bg-white rounded-2xl shadow-sm p-6 border border-gray-100 mb-8">
                    ...
                    <form method="POST" action="<?php echo e(route('owner.password.update')); ?>" onsubmit="return confirm('هل أنت متأكد من تغيير كلمة المرور؟')">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="bg-white rounded-3xl overflow-hidden shadow-sm hover:shadow-xl transition-all border border-gray-100 group">
                            <div class="h-48 bg-gray-100 relative">
                                ...
                                <div class="absolute top-4 left-4 shadow-lg">
                                    ...
                                    <?php elseif($business->status === 'approved' && ($business->contract_ends_at === null || $business->contract_ends_at > now())): ?>
                                    ...
                                    <?php elseif($business->contract_ends_at && $business->contract_ends_at <= now()): ?>
                            ...
                            <div class="p-6">
                                ...
                                <div class="flex items-center text-gray-400 text-sm gap-4 mb-4">
                                    <div class="flex items-center">
                                        ...
                                        <?php echo e($business->subArea?->name ?? 'غير محدد'); ?>
                                ...
                                <?php if($business->status === 'approved' && $business->contract_ends_at): ?>
                                <div class="mb-4 text-xs">
                                    ...
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="font-bold <?php echo e($daysLeft <= 3 ? 'text-red-500' : 'text-green-600'); ?>">
                                            <?php echo e($business->contract_ends_at->format('Y-m-d')); ?>

                                            <?php if($daysLeft !== null): ?>
                                                (<?php echo e($daysLeft > 0 ? $daysLeft . ' يوم متبقي' : 'منتهي'); ?>)
                                            <?php endif; ?>
                                        </span>
                                    </div>
                                </div>
        ...
        <div class="bg-gray-50 min-h-screen py-12">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="bg-white rounded-2xl shadow-sm p-8 border border-gray-100">
                    <h1 class="text-2xl font-bold text-gray-800 mb-4">مرحباً <?php echo e(Auth::user()->name); ?>!</h1>
                    <p class="text-gray-600">يمكنك الآن البحث عن المحال التجارية وإضافتها إلى المفضلة.</p>
                    <a href="<?php echo e(route('home')); ?>" class="mt-6 inline-block bg-brand-green text-white px-6 py-3 rounded-xl font-bold hover:opacity-90 transition-all">
                        ابدأ البحث
                    </a>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\LENOVO\Desktop\Wen-Sar\resources\views/dashboard.blade.php ENDPATH**/ ?>