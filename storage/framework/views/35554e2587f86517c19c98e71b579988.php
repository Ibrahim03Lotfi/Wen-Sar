<?php $__env->startSection('title', __('Edit Sub Area')); ?>
<?php $__env->startSection('page-title', __('Edit Sub Area')); ?>
...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-xl shadow-sm">
        ...
        <form method="POST" action="<?php echo e(route('manager.sub-areas.update', $subArea)); ?>" class="p-6">
            <?php echo csrf_field(); ?>
            ...
            <div class="mb-6">
                ...
                <input type="text" name="name" required value="<?php echo e(old('name', $subArea->name)); ?>"
            ...
            <div class="mb-6">
                ...
                <select name="district_id" required
                    ...
                    <?php $__currentLoopData = $districts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $district): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($district->id); ?>" <?php echo e((old('district_id', $subArea->district_id) == $district->id) ? 'selected' : ''); ?>>
                            <?php echo e($district->name); ?> (<?php echo e($district->governorate->name); ?>)
                        </option>
...
<?php echo $__env->make('layouts.manager', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\LENOVO\Desktop\Wen-Sar\resources\views\manager\sub-areas\edit.blade.php ENDPATH**/ ?>