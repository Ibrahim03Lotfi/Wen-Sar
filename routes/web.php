...
Route::get('/search', [BusinessController::class, 'search'])->middleware('throttle:search')->name('business.search');
Route::get('/api/search', [BusinessController::class, 'apiSearch'])->middleware('throttle:search')->name('business.api.search');
...
Route::middleware(['auth'])->prefix('owner')->name('owner.')->group(function () {
    ...
    Route::post('/businesses', [OwnerBusinessController::class, 'store'])->middleware('throttle:uploads')->name('businesses.store');
